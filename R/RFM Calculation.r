...
w#Check the structure of the new table and ensure that all the variables are numeric. ####
str(rfm)
...
# 6. The RFM function ####
RFMfunction <- function(transactions, weight_recency=1, weight_frequency=1, weight_monetary=1){
